      ...
      {linksOpen && <ModalShell labelledBy="links-dialog-title" className="links-dialog" onClose={() => setLinksOpen(false)} closeLabel="Close links and embeds">
        ...
        <div className="editor-body">
          ...
          <section className="links-section" aria-label="Multiviewer">
            <h3>Multiviewer</h3>
            <p className="links-description">Plays up to 12 default-size channels per page in a responsive grid; there is no combined multiview WHEP endpoint.</p>
...
function connectionHelp(label: string) {
  ...
  if (label.includes("Viewer URL")) return "Standalone multiview link with a responsive grid, up to 12 default-size channels per page, and drag-and-drop ordering.";
